...
return(
    ...
    <div className='PreFooter'>
        ...
        <div>
            {shieldIcon}
            <p><b>100% secure payment</b><br />We support Cards, Wallets, EMI, COD</p>
        </div>
        <div>
            {mapIcon}
            <p><b>Vast service network</b><br />1000 mi services-centers across 600 cities</p>
        </div>
        
        </div>

        <div className='PreFooter2'>
            <div><p>LET'S STYA IN TOUCH</p><span>Get updates on saless specials and more</span></div>
        ...
        <p>Thanks, You're on our email list for speical offers.</p>
        </div>
